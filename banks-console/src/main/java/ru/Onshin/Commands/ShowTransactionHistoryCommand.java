...
@CommandLine.Command(
        name = "show account transaction history"
)
public class ShowTransactionHistoryCommand implements Callable<Integer> {
    private FindService _findService;

    public ShowTransactionHistoryCommand(FindService findService) {
    ...
    public Integer call() {
        ...
        System.out.println(clientService.showTransactionHistory(account));
        return null;
    }
}
