...
public class WithdrawCommand implements Callable<Integer> {
    private FindService _findService;

    public WithdrawCommand(FindService findService) {
    ...
    public Integer call() {
        ...
        System.out.println(clientService.withdraw(account, bank, moneyValue));
        return null;
    }
}
